...
e->imageFond = SDL_LoadBMP("grand.bmp");
e->imagemini=IMG_Load("mini.bmp");
p->personnage = IMG_Load("face.png");
...
if (i==5){
           p->personnage=IMG_Load("face 2.png");}
if (i==8){
              p->personnage=IMG_Load("face 4.png");}
